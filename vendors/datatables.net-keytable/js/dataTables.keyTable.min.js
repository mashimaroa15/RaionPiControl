...
(function (e) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function (k) {
        ...
        k || (k = window);
        if (!g || !g.fn.dataTable)g = require("datatables.net")(k, g).$;
        return e(g, k, k.document)
    } : e(jQuery, window, document)
})(function (e, k, g, n) {
    var h = e.fn.dataTable, l = function (a, b) {
        if (!h.versionCheck || !h.versionCheck("1.10.8"))throw"KeyTable requires DataTables 1.10.8 or newer";
        this.c = e.extend(!0, {}, h.defaults.keyTable,
            l.defaults, b);
        this.s = {dt: new h.Api(a), enable: !0, focusDraw: !1};
        this.dom = {};
    ...
    e.extend(l.prototype, {
        blur: function () {
            ...
            if (this.c.blurable)e(g).on("click.keyTable", function (c) {
            ...
            if (this.c.editor)b.on("key.keyTable",
                function (b, c, d, e, g) {
                    a._editor(d, g)
                });
            ...
            if (c &&
                c.keyTable)b.one("init", function () {
            ...
            var c = this, f = this.s.dt, i = f.page.info(),
                m = this.s.lastFocus;
            if (this.s.enable) {
                if ("number" !== typeof a) {
                ...
                if (-1 !== i.length && (a < i.start || a >= i.start + i.length))this.s.focusDraw = !0, f.one("draw", function () {
                    c.s.focusDraw = !1;
                    c._focus(a, b)
                }).page(Math.floor(a / i.length)).draw(!1); else if (-1 !== e.inArray(b, this._columns())) {
                    i.serverSide && (a -= i.start);
                    i = f.cell(":eq(" + a + ")", b, {search: "applied"});
                    if (m) {
                        if (m.node() === i.node())return;
                        this._blur()
                    }
                    m = e(i.node());
                    m.addClass(this.c.className);
                    if (d === n || !0 === d)this._scroll(e(k), e(g.body), m, "offset"), d = f.table().body().parentNode, d !== f.table().header().parentNode && (d = e(d.parentNode), this._scroll(d, d, m, "position"));
                    this.s.lastFocus = i;
                    this._emitEvent("key-focus", [this.s.dt, i]);
                    f.state.save()
                }
            }
        }, _key: function (a) {
                ...
                if (b) {
                    ...
                    if (!(this.c.keys && -1 === e.inArray(a.keyCode, this.c.keys)))switch (a.keyCode) {
                        ...
                        case 40:
                            ...
                            break;
                        default:
                            !0 === this.s.enable && this._emitEvent("key", [c, a.keyCode, this.s.lastFocus, a])
                    }
                }
            }
            ...
            if (g) {
                var h = c.rows({filter: "applied", order: "applied"}).indexes().indexOf(g.index().row);
        ...
        _tabInput: function () {
            ...
            if (-1 != d)e('<div><input type="text" tabindex="' + d + '"/></div>').css({
                position: "absolute",
                height: 1,
                width: 0,
                overflow: "hidden"
    ...
    l.defaults = {blurable: !0, className: "focus", columns: "", editor: null, focus: null, keys: null, tabIndex: null};
    l.version = "2.1.2";
    ...
    h.Api.register("keys.enable()", function (a) {
        return this.iterator("table", function (b) {
            b.keytable && b.keytable.enable(a ===
            n ? !0 : a)
        })
    });
    h.ext.selector.cell.push(function (a, b, d) {
        ...
        if (!a || b === n)return d;
        for (var e = 0, g = d.length; e < g; e++)(!0 === b && a.focused(d[e]) || !1 === b && !a.focused(d[e])) && c.push(d[e]);
        return c
    });
    e(g).on("preInit.dt.dtk", function (a, b) {
        if ("dt" === a.namespace) {
            var d = b.oInit.keys, c = h.defaults.keys;
            if (d || c)c = e.extend({}, d, c), !1 !== d && new l(b, c)
        }
    });
    return l
});
