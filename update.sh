...
case $choice in
    1 ) echo "Syncing raion $choice ..." 
		rsync -e "ssh -i C:/Users/kennysang/.ssh/key_raion1" -avz --del ./ pi@10.8.0.3:/var/www/html/
		echo Sync completed !
		date
        ;;
    2 ) echo "Syncing raion $choice ..."
		rsync -e "ssh -i C:/Users/kennysang/.ssh/key_raion2" -avrz --delete-after --exclude '.idea/' --exclude '.git/' ./ pi@10.8.0.4:/var/www/html/
		echo Sync completed !
		date
        ;;
    3 ) echo "Syncing raion $choice ..."
		rsync -e "ssh -i C:/Users/kennysang/.ssh/key_raionpi3" -avz --del ./ pi@192.168.1.64:/var/www/html/
		echo Sync completed !
		date
        ;;
    * ) echo "Usage : "
